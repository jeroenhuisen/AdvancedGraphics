...
{	
	...
	Plane* plane = new Plane(glm::vec3(0, 1108, 0), glm::vec3(0, 1, 0), 100, 100, red); //why does it has to be 200 but show as 100? idk.
	Plane* plane1 = new Plane(glm::vec3(500, 1108, 300), glm::vec3(0, 1, 0), 100, 100, green); //why does it has to be 200 but show as 100? idk.
